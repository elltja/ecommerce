    ...
    >
      <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
        <div className='flex min-h-full items-center justify-center bg-[#0000004d]'>
          <DialogPanel
            transition
            className='w-fit max-w-1/2 flex-1 rounded-xl bg-white p-6 px-10 backdrop-blur-2xl duration-300 ease-out data-closed:transform-[scale(95%)] data-closed:opacity-0'
          >
            <div className='mb-5'>
